...
ADCP Parsing information taken from Ocean Observatories Initiatives
Marine Integrations Package
https://github.com/oceanobservatories/mi-instrument/tree/master/mi/instrument/teledyne/workhorse
2024-Jan-23
    ...
    def _parse_offset_data(self):
        ...
        for offset in self.offsets:
            ...
            if block_id == BlockId.FIXED_DATA:
                ...
                print('Found unhandled data type id: %d' % block_id)
                pass
